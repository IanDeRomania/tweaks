...
echo     ^│                             ^│ 
echo     ^│            Home             ^│         %r%hbn.x%l% - PC Tuning guide and AMD GPU debloating
echo     ^│                             ^│
echo     ^│                             ^│         %r%hbn.x%l% - AMD GPU tweaks
echo     ^│           Tweaks            ^│
echo     ^│                             ^│         %r%hbn.x (crown on top)%l% - Performance (FPS) and CPU tweaks
echo     ^│                             ^│         
echo     ^│       Ingame Settings       ^│         %r%hbn.xCTRL%l% - Functionally part, aswell as the backup and recording settings
echo     ^│                             ^│         
echo     ^│                             ^│         %r%hbn.x%l% - Privacy (privacy.sexy)
echo     ^│      Recording Settings     ^│
echo     ^│                             ^│         %r%hbn.x%l% - Vitality Website
echo     ^│                             ^│         
echo     ^│           Privacy           ^│         %e%hbn.x%l% - Low Audio Latency tweak
echo     ^│                             ^│
echo     ^│                             ^│         %e%hbn.x%l% - Various Nvidia GPU d-words
echo     ^│        Configuration        ^│      
echo     ^│                             ^│         %e%hbn.x%l% - Various performance (FPS) tweaks
echo     ^│                             ^│          
echo     ^│           %r%Credits%l%           ^│         %e%hbn.x%l% - Windows settings 
echo     ^│                             ^│
echo     ^│                             ^│         %ic%crown tweaking utility on top%l% 
echo     └─────────────────────────────┘        
echo.
echo.
choice /c:WS /n /m " "                                           
